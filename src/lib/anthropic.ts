...
export async function generateScript(params: {
  ...
  const user = [
    ...
    '- thumbnailHeadline: 썸네일에 크게 박을 아주 짧고 강한 후킹 문구. 한 줄에 5~9자씩 최대 2줄 분량(전체 18자 이내). 제목을 그대로 줄인 게 아니라 다음 후킹 공식 중 하나를 실제로 써서 새로 뽑아라: (1)의외의 숫자/사실 하나를 던지기(예: "본문엔 딱 1번" — 이 영상이면 "harness" 언급 1회라는 실제 사실 활용), (2)정곡을 찌르는 도발적 단정("그거 엔지니어링 아니다"), (3)정면 질문("이거 모르면 뒤처지나요?"), (4)극명한 대비("설정 vs 엔지니어링"). "~완벽정리", "~진짜 원리" 같은 뻔한 클리셰 문구는 피하고, 그 영상 안의 구체적 사실/숫자/단정을 직접 박아라. 제목과 달라도 됨, 클릭하고 싶게 만드는 게 최우선.',
